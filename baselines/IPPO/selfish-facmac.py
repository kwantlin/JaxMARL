...
def main(config):
    ...
    print(out["metrics"]["returned_episode_returns"].mean(axis=(0,2)))
    print("num_updates", out["metrics"]["returned_episode_returns"].shape, jnp.arange(out["metrics"]["returned_episode_returns"].shape[1]))
