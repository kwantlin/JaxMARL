...
def main(config):
    ...
    # print("end results", out["metrics"]["episode_returns"][:,-1,:,:]) # seed, steps, envs, agents
    print("averaged results", out["metrics"]["episode_returns"][:,-1,:,:].mean(axis=1)) # seed, steps, envs, agents
